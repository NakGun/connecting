...
class ConnectingOptions {
  ...
  static ConnectingOptions of(BuildContext context) {
    final _ModelBindingScope scope =
    context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>();
    return scope.modelBindingState.currentModel;
  }

  static void update(BuildContext context, ConnectingOptions newModel) {
    final _ModelBindingScope scope =
    context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>();
...
// Applies text ConnectingOptions to a widget
class ApplyTextOptions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final options = ConnectingOptions.of(context);
...
class ModelBinding extends StatefulWidget {
  ModelBinding({
    Key key,
    this.initialModel = const ConnectingOptions(),
    this.child,
  })  : assert(initialModel != null),
        super(key: key);

  final ConnectingOptions initialModel;
  final Widget child;
...
class _ModelBindingState extends State<ModelBinding> {
  ConnectingOptions currentModel;
  ...
  void handleTimeDilation(ConnectingOptions newModel) {
  ...
  void updateModel(ConnectingOptions newModel) {
